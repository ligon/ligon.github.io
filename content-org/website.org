...
* Papers
** Consumer Demand with Price Aggregators and Low-Rank Cross-Price Effects :Demand:Agriculture:
:PROPERTIES:
...
** Risk-Sharing Tests and Covariate Shocks: Drought, Floods, and Pests in Uganda :Risk_sharing:Welfare:Poverty:Agriculture:
:PROPERTIES:
...
** Credit and Welfare Across the Lean Season :Welfare:Experiments:Agriculture:
:PROPERTIES:
...
** Assessing Targeting Performance: The Case of Ghana's LEAP Program :Poverty:Welfare:Development:
:PROPERTIES:
...
** Consumption Subaggregates Should Not Be Used to Measure Poverty :Poverty:Welfare:Demand:
:PROPERTIES:
...
#+end_src** Informal Insurance Arrangements with Limited Commitment :Risk_sharing:
:PROPERTIES:
